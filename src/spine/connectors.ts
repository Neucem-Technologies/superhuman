...
export const CONNECTOR_CATALOG: ConnectorMeta[] = [
  ...
  },
  {
    ...
    live: {
      ...
      needs: [
        ...
        { name: "User link", kind: "oauth", detail: "User authorises Superhuman to read their ring cloud.", env: "ULTRAHUMAN_CLIENT_ID" },
  ...
  },
  {
    ...
    live: {
      ...
      needs: [
        { name: "GSTIN", kind: "account", detail: "The business GST number Superhuman will file against.", env: "GSTIN" },
